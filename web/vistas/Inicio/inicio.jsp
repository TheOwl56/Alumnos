            ...
            <div id="pestana_carrera">
                ...
                <label id="centrar">
                    <h4>
                        ...
                        <label> Para más información sobre el proceso de registro consulte <a href="http://192.168.40.112:8080/MODULO_ASPIRANTE/manualgenerar" target="_blank"> aquí.</a></label>
                    </h4>
                </label>
                <div>
                    <center>
